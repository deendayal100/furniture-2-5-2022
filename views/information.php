                                        ...
                                        <div class="maxwel">
                                            ...
                                            <div class="col-sm-6 ">
                                                ...
                                                <div class="form-group inputDnD">
                                                  ...
                                                  <input name="images[1][]" class="input-text itemimage1" accept="image/*"  id="inputFile" type="file" data-title="Select and Upload Image" required> 

                                                  <input name="images[1][]" class="input-text itemimage2" accept="image/*"  id="inputFile" type="file" data-title="Select and Upload Image" required >

                                                  <input name="images[1][]" class="input-text itemimage3" accept="image/*"  id="inputFile" type="file" data-title="Select and Upload Image" required>
                                                  <div class="row">  
                                                    <div id="invp1" class="col-4 previwes3"></div>
                                                    <div id="invp2" class="col-4 previwes1"></div>
                                                    <div id="invp3" class="col-4 previwes2"></div>
                                                  </div>
                                                </div>
                                              </div>
                                              <div class=" col-sm-6 ">
       ...
       var formData= new FormData(jQuery('#information')[0]);
		jQuery.ajax({
			...
			success:function(data) {      
				...
				if(obj.status==true){
					var id = obj.id;
                    Swal.fire('Application Submitted Succefully')
...
$('.previwes3').on('click',function(){
    $('.itemimage1').val('');
})
$('.previwes1').on('click',function(){
    $('.itemimage2').val('');
})
$('.previwes2').on('click',function(){
    $('.itemimage3').val('');
})
...
$('.itemimage2').on('change',function(){
    ...
    for (let i = 0; i < allFiles.length; i++) {
        var src = URL.createObjectURL(allFiles[i]);
        console.log('src - '+src);
        $("#invp2").prepend('<div class="ap rows_'+g+'"><img src="'+src+'" id="invoutput'+g+'" class="output"></img><span id="invoin'+g+'" class="invo1 threeVax" data-number="'+g+'" data-nax="invp1">X</span></div><script>$(".threeVax").on("click",function(){ var number = $(this).data("number"); var nax = $(this).data("nax"); $(".rows_"+number).remove();})<\/script>');
        g++;
    }
})

$('.itemimage3').on('change',function(){
    $(".ap img").show();
    var allFiles = this.files;
    var g=3;
    for (let i = 0; i < allFiles.length; i++) {
        var src = URL.createObjectURL(allFiles[i]);
        console.log('src - '+src);
        $("#invp3").prepend('<div class="ap rows_'+g+'"><img src="'+src+'" id="invoutput'+g+'" class="output"></img><span id="invoin'+g+'" class="invo1 threeVax" data-number="'+g+'" data-nax="invp1">X</span></div><script>$(".threeVax").on("click",function(){ var number = $(this).data("number"); var nax = $(this).data("nax"); $(".rows_"+number).remove();})<\/script>');
        g++;
    }
})
